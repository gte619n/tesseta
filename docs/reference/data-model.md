...
| `foodCatalog/{foodId}` **(shared)** | `nutrition.CatalogFood` | name, nameLower, brand, barcode, macrosPer100g, servingSizes, source:`{USDA,OPEN_FOOD_FACTS,USER,GEMINI_PHOTO,GEMINI_LABEL,GEMINI_DESCRIPTION}`, status:`{UNVERIFIED,VERIFIED}`, confirmationCount, imageUrl, imageStatus |
