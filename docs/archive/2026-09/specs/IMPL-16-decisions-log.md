...
> Evidence: `core/nutrition/Macros.java` (`withDerivedCalories()`), `NutritionService.java`; ratified 2026-06-10.
> Successor / current source of truth: docs/reference/feature-catalog.md.
> Note: this is the **med-reminders/nutrition-UX IMPL-16** (companion decision log) — NOT the active-workout-logging branch effort that also went by "IMPL-16".
