...
> Evidence: `web/components/admin/AdminExerciseCatalog.tsx`; ADR-0017 thumbnail Cloud Function deployed.
> Successor / current source of truth: the archived IMPL-20 spec + docs/reference/feature-catalog.md.
