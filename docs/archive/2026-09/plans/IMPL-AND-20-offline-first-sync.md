...
> Evidence: android `core-data` `SyncEngine.kt` (Room+SQLCipher mirror); backend `GET /api/me/sync` delta endpoint; ADR-0007 records the decision.
> Successor / current source of truth: ADR-0007 + docs/reference/feature-catalog.md.
