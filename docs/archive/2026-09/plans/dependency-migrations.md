> **ARCHIVED 2026-09-13** — Classification: SUPERSEDED.
> Evidence: the same three migrations re-planned with current detail by the 2026-09-13 audit; none executed yet — the *work* is live, this doc is no longer the plan of record.
> Successor / current source of truth: docs/audit/2026-09-13/migrations/MIG-001..MIG-004.
