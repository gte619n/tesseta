...
> Evidence: `core/medication/TimeSlot.java` (nullable explicit time), `missed` on dose log; ratified 2026-08-27.
> Successor / current source of truth: IMPL-21-single-rolling-medication-reminder.md (archived alongside) + docs/reference/feature-catalog.md.
