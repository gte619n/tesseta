...
> Evidence: same code as the archived IMPL-18 spec (../specs/IMPL-18-conversational-program-designer.md); ratified 2026-06-14.
> Successor / current source of truth: the archived IMPL-18 spec + docs/reference/feature-catalog.md.
