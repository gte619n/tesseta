...
> Evidence: `LeftoverService.java`, `LeftoverMath.java`, `api/nutrition/EntryResponse.java` (`leftover`, `adjustment`); android `Leftover`/`LeftoverStatus` in `core-domain` `Nutrition.kt`.
