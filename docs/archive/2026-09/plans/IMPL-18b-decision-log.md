...
> Evidence: `core/workoutprogram/chat/WorkoutProgramChatThread.java` (`programId`); commit-path reuse per D1/D2.
> Successor / current source of truth: the archived IMPL-18b spec + docs/reference/feature-catalog.md.
