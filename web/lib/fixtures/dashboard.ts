...
export const navItems = [
  ...
  { label: "Body", icon: "body-scan", active: false },
  { label: "Blood", icon: "droplet", active: false, badge: "2" },
  { label: "Workouts", icon: "barbell", active: false },
  { label: "Nutrition", icon: "bowl", active: false },
  { label: "Meds", icon: "pill", active: false },
