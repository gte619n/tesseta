...
/**
 * The phone bottom nav is space-constrained — show only the four most
 * frequent destinations. Settings + secondary items move into the "More"
 * destination once that lands in IMPL-AND-02.
 */
