...
fun FoldableDashboardScreen(
    ...
    val workoutVm: TodayWorkoutViewModel = hiltViewModel()
    ...
    val workoutState by workoutVm.state.collectAsStateWithLifecycle()
    ...
    Box(
        ...
        Row(modifier = Modifier.fillMaxSize().windowInsetsPadding(WindowInsets.statusBars)) {
            ...
            Column(
                ...
                TodaysWorkoutCard(
                    state = workoutState,
                    onStart = { id -> onNavigate(WorkoutsRoutes.sessionOverview(id)) },
                    onViewSummary = { id -> onNavigate(WorkoutsRoutes.sessionSummary(id)) },
