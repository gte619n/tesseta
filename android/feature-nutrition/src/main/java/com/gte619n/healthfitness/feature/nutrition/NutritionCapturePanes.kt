 ...
 */
internal fun loadJpegFromUri(context: Context, uri: Uri, maxDim: Int = 1568): ByteArray {
...
@Composable
internal fun BarcodeMissPane(code: String, onFallback: () -> Unit, onCancel: () -> Unit) {
...
@Composable
internal fun MealItemsPane(items: List<MealCaptureItem>, onConfirm: (List<MealCaptureItem>) -> Unit, onCancel: () -> Unit) {
...
@Composable
internal fun MealItemCard(item: MealCaptureItem, onChangePortion: (Double) -> Unit, onRemove: () -> Unit) {
...
@Composable
internal fun LabelDraftPane(food: LabelCaptureFood, onConfirm: (Int, Double) -> Unit, onCancel: () -> Unit) {
...
@Composable
internal fun DonePane(message: String, onAgain: () -> Unit) {
    Column(
...
@Composable
internal fun CameraDenied(onRequest: () -> Unit) {
    Column(
        modifier = Modifier.fillMaxSize().padding(24.dp),
        horizontalAlignment = Alignment.CenterHorizontally,
        verticalArrangement = Arrangement.Center,
