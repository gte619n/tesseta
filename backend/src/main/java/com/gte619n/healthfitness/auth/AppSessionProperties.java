...
//
// Benign replays of a rotated refresh token (a refresh whose response was lost
// in flight on a flaky mobile network) are handled by the successor-chain walk
// in SessionTokenService — see ADR-0019 — not a time window, so there is no
// grace-period knob.
