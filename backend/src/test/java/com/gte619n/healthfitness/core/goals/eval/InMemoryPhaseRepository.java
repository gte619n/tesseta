...
/**
 * Minimal in-memory {@link PhaseRepository} for the core tests in this
 * package — local copy mirroring the {@code app}-module version.
 */
final class InMemoryPhaseRepository implements PhaseRepository {
