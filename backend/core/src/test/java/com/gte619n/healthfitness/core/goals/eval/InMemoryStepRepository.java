...
/**
 * Minimal in-memory {@link StepRepository} for core tests — local copy
 * mirroring the {@code app}-module version.
 */
final class InMemoryStepRepository implements StepRepository {
